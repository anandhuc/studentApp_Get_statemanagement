...
import 'package:studentdetails_getx/Pages/search_page.dart';
import 'package:studentdetails_getx/Pages/std_detials.dart';
...
import 'package:studentdetails_getx/widgets/add_record.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: IconButton(
             icon: Icon(Icons.search_rounded,color: Color.fromARGB(255, 12, 12, 12) ,), 
              onPressed: () {
                Get.to(() => SearchPage());
              },
            ),
